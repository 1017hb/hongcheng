...
export function userLevelPurchasevip(vip_type,u_id) {
  return request.get("user/level/purchaseVip", { vip_type: vip_type, u_id: u_id  });
}
*/
 ...
 * 
 */
export function userLevelPurchasevip(level) {
  return request.get('user/level/purchasevip/' + level);
}
